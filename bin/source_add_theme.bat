...
%external%\ssr\ssr --nobackup --recurse --encoding utf8 --dir "%bindir%\languages" --include "*.ini" --alter --search "LANG_TITL_SETTINGS-ABOUT-MAIN" --replace "LANG_TITL_SETTINGS-THEMES-PACKS-%themeid%=%themetitle%/SSR_CR//SSR_LF/LANG_INFO_SETTINGS-THEMES-PACKS-%themeid%=%themeinfo%. Author: %themeauthor%/SSR_CR//SSR_LF/LANG_TITL_SETTINGS-ABOUT-MAIN"
